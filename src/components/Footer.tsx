...
export default function Footer() {
  ...
  // Added the new GitHub links here
  const githubRepos = [
    { name: 'Mobile Frontend', href: 'https://github.com/Chalani810/oudra-mobile' },
    { name: 'Web App Frontend', href: 'https://github.com/Chalani810/oudra_client' },
    { name: 'Server Backend', href: 'https://github.com/Chalani810/oudra_server' },
  ];
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              ...
              <div className="pt-4 flex flex-col space-y-2">
                <div className="flex items-center space-x-2 text-gray-300 font-medium mb-1">
                ...
                {githubRepos.map((repo) => (
                  <a 
                    ...
                    className="text-sm text-gray-400 hover:text-green-400 transition-colors pl-7"
                  >
                    • {repo.name}
                  </a>
                ))}
